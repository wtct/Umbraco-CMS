<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="insertDedicatedImage.aspx.cs" Inherits="umbraco.presentation.plugins.tinymce3.insertDedicatedImage" %>
...
<body id="advimage" style="display: none">
    ...
    <ui:Pane ID="pane_select" runat="server"> 
      ...
      <div style="padding: 5px; background: #fff; height: 250px;">
        ...
        <umb2:Tree runat="server" ID="DialogTree" ManualInitialization="true"
            App="media" TreeType="dedicatedMedia" IsDialog="true" 
    ...
    <p>
      <input id="SubmitinsertDedicatedImage" type="submit" value="{#insert}" style="width: 60px;" onclick="ImageDialog.insert();return false;" /> <em>or</em> <a href="#" onclick="tinyMCEPopup.close();">{#cancel}</a>
    </p>   
